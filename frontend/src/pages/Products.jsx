                ...
                <RadioGroup
                  ...
                  onChange={(e) => {
                    ...
                    const path =
                      selected === "all"
                        ? "/products"
                        : `/products/${encodeURIComponent(selected)}`;
                ...
                >
                  {categories.map((cat) => (
                    <FormControlLabel
                      ...
                      value={cat}
                      control={
                        <Radio size="small" style={{ color: "#172c56" }} />
                      }
                      label={
                        cat === "all"
                          ? "All"
        ...
        <Container sx={{ mt: 8, mr: 8 }}>
          ...
          >
            {sortedProducts.map((product) => {
              ...
              return (
                <Grid sx={{ xs: 12, sm: 6, md: 4 }} key={product._id}>
                  <Card
                    sx={{
                      minHeight: "380px",
                      maxHeight: "380px",
...
//is page me asa karna hai jese add to product page par click kre toh usi ki jgha par go to cart button aaye orr jo quantity hai increment or decrement wo add to cart click krne par aa jaye
